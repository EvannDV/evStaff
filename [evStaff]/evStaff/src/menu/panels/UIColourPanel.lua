---@type table
local Colour = {
    Background = { Dictionary = "evStaff", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 112 },
    LeftArrow = { Dictionary = "evStaff", Texture = "arrowleft", X = 7.5, Y = 15, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "evStaff", Texture = "arrowright", X = 393.5, Y = 15, Width = 30, Height = 30 },
